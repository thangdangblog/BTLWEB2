...
namespace MITComputerWebForm.share
{

    
    public class Share
    {
        public static string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Baitap\WEB2\MITComputerWebForm\App_Data\QLMIT.mdf;Integrated Security=True";
